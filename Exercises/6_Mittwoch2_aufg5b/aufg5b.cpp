...
OutIt real_unique_copy_helper(InIt beg, InIt end, OutIt dest) {
...
template<class ElemType, class OutIt>
inline
OutIt real_unique_copy(const ElemType *beg, const ElemType *const end, OutIt dest) {
	// ..........
	// TO-BE-DONE
	// ..........
}
